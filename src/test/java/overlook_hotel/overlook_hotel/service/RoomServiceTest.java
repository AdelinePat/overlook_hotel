...
public class RoomServiceTest {
    ...
    public void findByNumber() {
        List<Room> rooms = roomService.findAllFiltered(105, null, null, null, null, null, null, null);
    ...
    public void findByCapacity() {
        List<Room> rooms = roomService.findAllFiltered(null, 2, null, null, null, null, null, null);
    ...
    public void findByStanding() {
        List<Room> rooms = roomService.findAllFiltered(null, null, null, this.roomStanding, null, null, null, null);
    ...
    public void findByBedType() {
        List<Room> rooms = roomService.findAllFiltered(null, null, null, null, this.type, null, null, null);
    ...
    public void findByLowerThan() {
        List<Room> rooms = roomService.findAllFiltered(null, null, null, null, null, null, null, night_price_lower);
    ...
    public void findByGreaterThan() {
        List<Room> rooms = roomService.findAllFiltered(null, null, null, null, null, null,null, night_price_greater);
    ...
    public void findByBetween() {
        List<Room> rooms = roomService.findAllFiltered(null, null, null, null, null, null, null, night_price_between);
    ...
    public void findByDescriptionContent() {
        List<Room> rooms = roomService.findAllFiltered(null, null, "with", null, null, null, null, null);
    ...
    public void findByAvailability() {
        List<Room> rooms = roomService.findAllFiltered(null, null, null, null, null, this.startDate, this.endDate, null);
